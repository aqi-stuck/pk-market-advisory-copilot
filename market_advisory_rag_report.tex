...
Initial development efforts focused on emerging markets, specifically the Pakistan Stock Exchange (PSX). However, data acquisition proved a primary bottleneck; the lack of structured, digitized, and timely financial disclosures hindered the performance of retrieval mechanisms. Consequently, the research pivot toward the US market was executed to leverage mature data infrastructures (SEC, FRED), enabling the evaluation of sophisticated reranking and citation-grounding techniques in a data-rich environment.
...
\begin{itemize}
  ...
  \item A production-ready FastAPI service with PostgreSQL audit logging, Alembic
        migrations, deployment configuration for Render, and GitHub Actions CI/CD.
\end{itemize}
